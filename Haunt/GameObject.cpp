...
GameObject::GameObject(Texture* t_texture_to_use)
{
	position.X = 0;
	position.Y = 0;
...
GameObject::GameObject(Texture* t_texture_to_use, const Vector2D t_new_position)
{
...
GameObject::GameObject(Texture* t_texture_to_use, const Vector2D t_new_position, const float t_new_rotation)
{
	position = t_new_position;
...
GameObject::GameObject(Texture* t_texture_to_use, const Vector2D t_new_position, const Vector2D t_new_scale)
{
	position = t_new_position;
...
GameObject::GameObject(Texture* t_texture_to_use, const Vector2D t_new_position, const Vector2D t_new_scale, const float t_new_rotation)
{
	position = t_new_position;
	rotation = t_new_rotation;
...
void GameObject::Render(SDL_Renderer* t_renderer) const
{
