...
Dynamic::Dynamic(GLuint* t_texture_to_use) : GameObject(t_texture_to_use)
{
}

Dynamic::Dynamic(GLuint* t_texture_to_use, const Vector2D t_new_position) : GameObject(t_texture_to_use, t_new_position)
{
}

Dynamic::Dynamic(GLuint* t_texture_to_use, const Vector2D t_new_position, const float t_new_rotation) : GameObject(
